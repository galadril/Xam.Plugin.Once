    ...
    public class MainPageViewModel : ObservableObject
    {
        ...
        public MainPageViewModel()
        {
            ...
            if(Once.Instance.LastRunAt(SHOW_SURVEY) == null)
                Once.Instance.RunWhen(SHOW_SURVEY, new Command(() => UserDialogs.Instance.Toast("Show app survey")), true, new After() { RunAfter = 30, Type = After.AfterType.Days });
            else
                Once.Instance.RunWhen(SHOW_SURVEY, new Command(() => UserDialogs.Instance.Toast("Show app survey")), true, new After() { RunAfter = 90, Type = After.AfterType.Days });
